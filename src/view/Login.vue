<template>
    ...
    <section class="authentication-form">
      ...
      <div>
        ...
        <p class="text-center">Welcome to Link, Please Login with your personal account information.</p>
        <div class="card">
          <form class="theme-form">
            ...
            <div class="form-group row">
              ...
              <a href="#/" class="text-right col-6 theme-link">lost your password</a>
            </div>
